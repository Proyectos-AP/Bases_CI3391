...
/*
	...
	- R3: Los productos pedidos por el cliente no pueden existir en el inventario.
		Traduccion: No se puede traducir con CONSTRAINTS. Involucra mas de una tabla (PIDE y PRODUCTO).

	- R4: En la modalidad trueque, si el cliente cambia su objeto por uno de menor valor la tienda 
	   le hará un pago al cliente por la diferencia de montos.
